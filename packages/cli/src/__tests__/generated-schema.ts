...
type BacklogTable = {
  ...
  responsible: LinkColumnType<'collaboratorsTable', false>;
  ...
  coResponsible: LinkColumnType<'collaboratorsTable', false>;
  sprint: LinkColumnType<'sprints', false>;
  epic: LinkColumnType<'epics', false>;
  attachment: AttachmentColumnType<false>;
  modifiedBy: LinkColumnType<'collaboratorsTable', false>;
...
type EpicsTable = {
  ...
  collaborator: LinkColumnType<'collaboratorsTable', false>;
  description: TextColumnType<false>;
