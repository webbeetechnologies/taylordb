...
export const ChatsTypeOptions = ['private', 'group'] as const;
...
type ChatsTable = {
  ...
  type: SingleSelectColumnType<typeof ChatsTypeOptions, false>;
  participants: LinkColumnType<'users', false>;
  messages: LinkColumnType<'messages', false>;
  activities: LinkColumnType<'activities', false>;
};

export const MessagesTypeOptions = [
  'text',
  'image',
  'video',
  'file',
...
type MessagesTable = {
  ...
  sender: LinkColumnType<'users', true>;
  attachments: AttachmentColumnType<false>;
  voice: AttachmentColumnType<false>;
  messages12: LinkColumnType<'messages', false>;
  repliedTo: LinkColumnType<'messages', false>;
  type: SingleSelectColumnType<typeof MessagesTypeOptions, false>;
  createdTime: AutoGeneratedDateColumnType;
  chats: LinkColumnType<'chats', false>;
  activities12: LinkColumnType<'activities', false>;
};
type UsersTable = {
  id: NumberColumnType<false>;
  createdAt: AutoGeneratedDateColumnType;
  updatedAt: AutoGeneratedDateColumnType;
  name: TextColumnType<true>;
  messages1: LinkColumnType<'messages', false>;
  avatar: AttachmentColumnType<false>;
  phoneNumber: TextColumnType<false>;
  username: TextColumnType<true>;
  chats12: LinkColumnType<'chats', false>;
  activities1: LinkColumnType<'activities', false>;
};
type ActivitiesTable = {
  ...
  updatedAt: AutoGeneratedDateColumnType;
  name: TextColumnType<false>;
  chat: LinkColumnType<'chats', false>;
  user: LinkColumnType<'users', false>;
  lastSeenMessage: LinkColumnType<'messages', false>;
};
