...
type IncomeTable = {
  ...
  budget1: LinkColumnType<'budget', false>;
};

export const ExpensesCategoryOptions = [
  'Food',
  'Transport',
  'Utilities',
  'Rent',
...
type ExpensesTable = {
  ...
  date: DateColumnType<false>;
  amount: NumberColumnType<false>;
  category: SingleSelectColumnType<typeof ExpensesCategoryOptions, false>;
  budget: LinkColumnType<'budget', false>;
  receipt: AttachmentColumnType<false>;
};
type BudgetTable = {
  id: NumberColumnType<false>;
  createdAt: AutoGeneratedDateColumnType;
  updatedAt: AutoGeneratedDateColumnType;
  name: TextColumnType<false>;
  expenses: LinkColumnType<'expenses', false>;
  income: LinkColumnType<'income', false>;
  totalIncome: NumberColumnType<false>;
  totalExpenses: NumberColumnType<false>;
  remaining: NumberColumnType<false>;
};
